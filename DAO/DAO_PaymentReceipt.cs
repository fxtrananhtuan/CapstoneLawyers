...
namespace DAO
{
     public class DAO_PaymentReceipt
    {
        ...
        public void Fill_On_Word(string client, string matter,string Received, string GST, string Amount, string Receipt, string MatterDes, string mr, string lastname, string email, string Balance, string Matter_location, string template_location)
        {
            Microsoft.Office.Interop.Word.Application wordApp = new Microsoft.Office.Interop.Word.Application();
            Document wordDoc = new Document();
            Object oTemplatePath = template_location + "PaymentReceipt.dotx";
            ...
            foreach (Field myMergeField in wordDoc.Fields)
            {
                ...
                if (fieldText.StartsWith(" MERGEFIELD"))
                {
                    ...
                    if (fieldName == "Receipt")
                    {
                        ...
                        wordApp.Selection.TypeText(Receipt);
            ...
            string name = matter + "-PaymentReceipt";
